...
¿Necesitas mantener sincronizados los archivos `.env` entre máquinas, entornos, o miembros del equipo?  
Usa [dotenv-vault](https://github.com/dotenv-org/dotenv-vault).
