    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0B0F19] px-4 py-20 relative overflow-hidden">
      ...
      >
        ...
        <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest"><span className="px-4 bg-transparent text-gray-500 font-bold backdrop-blur-3xl">Or Construct via</span></div>
        </div>

        <button 
          onClick={() => window.location.href = 'http://localhost:5000/api/google'}
          className="w-full py-4 flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold rounded-xl transition-all hover:border-purple-400/30 group"
        >
